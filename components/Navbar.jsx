    ...
    <>
      <nav
        className={`fixed top-0 w-full px-6 lg:px-12 xl:px-[10%] py-4 flex items-center justify-between z-50 transition-all duration-300 ${
          isScroll ? 'bg-[#F9FAFB] dark:bg-gray-900/80 backdrop-blur-md shadow-md' : 'bg-transparent'
        }`}
      >
        <a href="#home">
          <Image
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            onClick={() => (sideMenuRef.current.style.transform = 'translateX(0)')}
          >
        ...
        >
          <button
            ...
            onClick={() => (sideMenuRef.current.style.transform = 'translateX(16rem)')}
          >
